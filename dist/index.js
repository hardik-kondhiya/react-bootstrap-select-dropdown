...
var BootstrapSelect = function BootstrapSelect(_ref) {
  ...
  }, [selectedValue, selectedKey]); // Set dropdown menu height
  ...
  }, [menuVisible]); // Get all selected value
  ...
  (0, _react.useEffect)(function () {
    ...
    window.addEventListener('resize', handleResize); // Handle event on window scroll
...
module.exports = BootstrapSelect; // Developed by Hardik Kondhiya <sonihardik90@gmail.com>